...
La descripción breve del proceso de acceso de la base y el procesamiento de las bases de dengue a través de la imagenes, y la proporción de las dos muestra de base de datos del estado de Guerrero, constituyen elementos clave para comprobar que la actividad de bajar y limpiar la base de datos de dengue del sinave. Es importante señalar que estas bases se actualizar de manera semanal para la identificación de las áreas con transmisión activa.
